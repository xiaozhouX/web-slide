define(['app/simple/view', 'tpl!app/template/slide.tpl', 'utils/fullscreen', 'utils/domEvent/mouseDrag', 'utils/keepRange'], function (View, tpl, fullscreen, mouseDrag, keepRange) {
  return View.extend({
    ...
    _fullScreenInit: function() {
      var self = this,
          elem = document.getElementById('play-slide'),
          scaleNum = this.appConfig.fullScreenScale(elem);
      this.fullscreen = fullscreen.init(elem, function(){
        elem.style.transform = 'scale(' + scaleNum + ')';
      }, function(){
