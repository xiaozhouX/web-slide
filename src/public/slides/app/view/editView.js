    ...
    data:{
        ...
        option: {
          transition:[
            ...
            { text: 'Rotation-Corner', value: 'rotation-corner' },
            { text: 'Rotation-Center', value: 'rotation-center' },
