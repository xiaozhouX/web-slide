...
define(['./array', './lang'], function(Arr, Lang) {
  ...
  _.convertHandler = function(handler, context) {
    return Arr.reduce(handler, function(memo, fn, eventName){
        if(Lang.isString(fn)){
          fn = context[fn];
        }
        if(fn){
...
define(function() {
  ...
  _.isString = function(array) {
    return !! !!array && _toString(array) === '[object String]';
  };
  _.isArray = function(array) {
    return !! Array.isArray(array) || !!array && _toString(array) === '[object Array]';
  };
